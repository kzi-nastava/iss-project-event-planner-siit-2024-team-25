...
ALTER TABLE "user"
    ADD CONSTRAINT uc_user_account UNIQUE (account_id);

ALTER TABLE accounts
    ADD CONSTRAINT FK_ACCOUNTS_ON_USER FOREIGN KEY (user_id) REFERENCES "user" (id);

ALTER TABLE activities
    ADD CONSTRAINT FK_ACTIVITIES_ON_EVENT FOREIGN KEY (event_id) REFERENCES events (id);

ALTER TABLE administrators
    ADD CONSTRAINT FK_ADMINISTRATORS_ON_ID FOREIGN KEY (id) REFERENCES "user" (id);
...
ALTER TABLE event_attendance
    ADD CONSTRAINT FK_EVENTATTENDANCE_ON_ATTENDEEID FOREIGN KEY (attendee_id) REFERENCES "user" (id);
...
ALTER TABLE event_organizers
    ADD CONSTRAINT FK_EVENT_ORGANIZERS_ON_ID FOREIGN KEY (id) REFERENCES "user" (id);
...
ALTER TABLE owners
    ADD CONSTRAINT FK_OWNERS_ON_ID FOREIGN KEY (id) REFERENCES "user" (id);

ALTER TABLE product
    ADD CONSTRAINT FK_PRODUCT_ON_OFFERINGCATEGORY FOREIGN KEY (offering_category_id) REFERENCES offering_type (id);

ALTER TABLE product
    ADD CONSTRAINT FK_PRODUCT_ON_OWNER FOREIGN KEY (owner_id) REFERENCES owners (id);
...
ALTER TABLE service
    ADD CONSTRAINT FK_SERVICE_ON_OWNER FOREIGN KEY (owner_id) REFERENCES owners (id);

ALTER TABLE suspensions
    ADD CONSTRAINT FK_SUSPENSIONS_ON_ACCOUNT FOREIGN KEY (account_id) REFERENCES accounts (id);

ALTER TABLE "user"
    ADD CONSTRAINT FK_USER_ON_ACCOUNT FOREIGN KEY (account_id) REFERENCES accounts (id);
...
ALTER TABLE favorite_events
    ADD CONSTRAINT fk_faveve_on_user FOREIGN KEY (user_id) REFERENCES "user" (id);
...
ALTER TABLE user_blocks
    ADD CONSTRAINT fk_useblo_on_blocked FOREIGN KEY (blocked_id) REFERENCES "user" (id);

ALTER TABLE user_blocks
    ADD CONSTRAINT fk_useblo_on_blocker FOREIGN KEY (blocker_id) REFERENCES "user" (id);

ALTER TABLE user_notifications
    ADD CONSTRAINT fk_usenot_on_notification FOREIGN KEY (notifications_id) REFERENCES notification (id);

ALTER TABLE user_notifications
    ADD CONSTRAINT fk_usenot_on_user FOREIGN KEY (user_id) REFERENCES "user" (id);